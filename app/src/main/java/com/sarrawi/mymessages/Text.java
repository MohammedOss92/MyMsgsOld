...
//        });
        ...
        this.press.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                int j;
                Text.hideSoftKeyboard(Text.this);
                String o0 = Text.this.input.getText().toString();
                String o3 = Text.this.input.getText().toString();
                String o4 = Text.this.input.getText().toString();
                String o5 = Text.this.input.getText().toString();
                String o6 = Text.this.input.getText().toString();
                String o7 = Text.this.input.getText().toString();
                String o8 = Text.this.input.getText().toString();
                String o9 = Text.this.input.getText().toString();
                String org = Text.this.input.getText().toString();
                ...
                Text.this.out1.setText(org);
                Text.this.out2.setText(o0);
                Text.this.out3.setText(o3);
                Text.this.out4.setText(o4);
                Text.this.out5.setText(o5);
                Text.this.out6.setText(o6);
                Text.this.out7.setText(o7);
                Text.this.out8.setText(o8);
                Text.this.out9.setText(o9);
            }
        });
        this.copy1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ((ClipboardManager) Text.this.getSystemService(Context.CLIPBOARD_SERVICE)).setText(Text.this.out1.getText().toString());
                Toast.makeText(Text.this.getBaseContext(), "\u062a\u0645 \u0646\u0633\u062e \u0645\u062d\u062a\u0648\u0649 \u0645\u0631\u0628\u0639 \u0627\u0644\u0646\u0635 \u0627\u0644\u0646\u0627\u062a\u062c", Toast.LENGTH_LONG).show();
            }
        });
        this.share1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                sharingIntent.putExtra("android.intent.extra.TEXT", Text.this.out1.getText().toString());
                Text.this.startActivity(Intent.createChooser(sharingIntent, "\u0634\u0627\u0631\u0643 \u0628\u0648\u0627\u0633\u0637\u0629 :"));
            }
        });
        this.copy2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ((ClipboardManager) Text.this.getSystemService(Context.CLIPBOARD_SERVICE)).setText(Text.this.out2.getText().toString());
                Toast.makeText(Text.this.getBaseContext(), "\u062a\u0645 \u0646\u0633\u062e \u0645\u062d\u062a\u0648\u0649 \u0645\u0631\u0628\u0639 \u0627\u0644\u0646\u0635 \u0627\u0644\u0646\u0627\u062a\u062c", Toast.LENGTH_LONG).show();
            }
        });
        this.share2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent sharingIntent = new Intent("android.intent.action.SEND");
                sharingIntent.setType("text/plain");
                sharingIntent.putExtra("android.intent.extra.TEXT", Text.this.out2.getText().toString());
                Text.this.startActivity(Intent.createChooser(sharingIntent, "\u0634\u0627\u0631\u0643 \u0628\u0648\u0627\u0633\u0637\u0629 :"));
            }
        });
        this.copy3.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ((ClipboardManager) Text.this.getSystemService(Context.CLIPBOARD_SERVICE)).setText(Text.this.out3.getText().toString());
                Toast.makeText(Text.this.getBaseContext(), "\u062a\u0645 \u0646\u0633\u062e \u0645\u062d\u062a\u0648\u0649 \u0645\u0631\u0628\u0639 \u0627\u0644\u0646\u0635 \u0627\u0644\u0646\u0627\u062a\u062c", Toast.LENGTH_LONG).show();
            }
        });
        this.share3.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent sharingIntent = new Intent("android.intent.action.SEND");
                sharingIntent.setType("text/plain");
                sharingIntent.putExtra("android.intent.extra.TEXT", Text.this.out3.getText().toString());
                Text.this.startActivity(Intent.createChooser(sharingIntent, "\u0634\u0627\u0631\u0643 \u0628\u0648\u0627\u0633\u0637\u0629 :"));
            }
        });
        this.copy4.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ((ClipboardManager) Text.this.getSystemService(Context.CLIPBOARD_SERVICE)).setText(Text.this.out4.getText().toString());
                Toast.makeText(Text.this.getBaseContext(), "\u062a\u0645 \u0646\u0633\u062e \u0645\u062d\u062a\u0648\u0649 \u0645\u0631\u0628\u0639 \u0627\u0644\u0646\u0635 \u0627\u0644\u0646\u0627\u062a\u062c", Toast.LENGTH_LONG).show();
            }
        });
        this.share4.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent sharingIntent = new Intent("android.intent.action.SEND");
                sharingIntent.setType("text/plain");
                sharingIntent.putExtra("android.intent.extra.TEXT", Text.this.out4.getText().toString());
                Text.this.startActivity(Intent.createChooser(sharingIntent, "\u0634\u0627\u0631\u0643 \u0628\u0648\u0627\u0633\u0637\u0629 :"));
            }
        });
        this.copy5.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ((ClipboardManager) Text.this.getSystemService(Context.CLIPBOARD_SERVICE)).setText(Text.this.out5.getText().toString());
                Toast.makeText(Text.this.getBaseContext(), "\u062a\u0645 \u0646\u0633\u062e \u0645\u062d\u062a\u0648\u0649 \u0645\u0631\u0628\u0639 \u0627\u0644\u0646\u0635 \u0627\u0644\u0646\u0627\u062a\u062c", Toast.LENGTH_LONG).show();
            }
        });
        this.share5.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent sharingIntent = new Intent("android.intent.action.SEND");
                sharingIntent.setType("text/plain");
                sharingIntent.putExtra("android.intent.extra.TEXT", Text.this.out5.getText().toString());
                Text.this.startActivity(Intent.createChooser(sharingIntent, "\u0634\u0627\u0631\u0643 \u0628\u0648\u0627\u0633\u0637\u0629 :"));
            }
        });
        this.copy6.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ((ClipboardManager) Text.this.getSystemService(Context.CLIPBOARD_SERVICE)).setText(Text.this.out6.getText().toString());
                Toast.makeText(Text.this.getBaseContext(), "\u062a\u0645 \u0646\u0633\u062e \u0645\u062d\u062a\u0648\u0649 \u0645\u0631\u0628\u0639 \u0627\u0644\u0646\u0635 \u0627\u0644\u0646\u0627\u062a\u062c", Toast.LENGTH_LONG).show();
            }
        });
        this.share6.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent sharingIntent = new Intent("android.intent.action.SEND");
                sharingIntent.setType("text/plain");
                sharingIntent.putExtra("android.intent.extra.TEXT", Text.this.out6.getText().toString());
                Text.this.startActivity(Intent.createChooser(sharingIntent, "\u0634\u0627\u0631\u0643 \u0628\u0648\u0627\u0633\u0637\u0629 :"));
            }
        });
        this.copy7.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ((ClipboardManager) Text.this.getSystemService(Context.CLIPBOARD_SERVICE)).setText(Text.this.out7.getText().toString());
                Toast.makeText(Text.this.getBaseContext(), "\u062a\u0645 \u0646\u0633\u062e \u0645\u062d\u062a\u0648\u0649 \u0645\u0631\u0628\u0639 \u0627\u0644\u0646\u0635 \u0627\u0644\u0646\u0627\u062a\u062c", Toast.LENGTH_LONG).show();
            }
        });
        this.share7.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent sharingIntent = new Intent("android.intent.action.SEND");
                sharingIntent.setType("text/plain");
                sharingIntent.putExtra("android.intent.extra.TEXT", Text.this.out7.getText().toString());
                Text.this.startActivity(Intent.createChooser(sharingIntent, "\u0634\u0627\u0631\u0643 \u0628\u0648\u0627\u0633\u0637\u0629 :"));
            }
        });
        this.copy8.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ((ClipboardManager) Text.this.getSystemService(Context.CLIPBOARD_SERVICE)).setText(Text.this.out8.getText().toString());
                Toast.makeText(Text.this.getBaseContext(), "\u062a\u0645 \u0646\u0633\u062e \u0645\u062d\u062a\u0648\u0649 \u0645\u0631\u0628\u0639 \u0627\u0644\u0646\u0635 \u0627\u0644\u0646\u0627\u062a\u062c", Toast.LENGTH_LONG).show();
            }
        });
        this.share8.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent sharingIntent = new Intent("android.intent.action.SEND");
                sharingIntent.setType("text/plain");
                sharingIntent.putExtra("android.intent.extra.TEXT", Text.this.out8.getText().toString());
                Text.this.startActivity(Intent.createChooser(sharingIntent, "\u0634\u0627\u0631\u0643 \u0628\u0648\u0627\u0633\u0637\u0629 :"));
            }
        });
        this.copy9.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ((ClipboardManager) Text.this.getSystemService(Context.CLIPBOARD_SERVICE)).setText(Text.this.out9.getText().toString());
                Toast.makeText(Text.this.getBaseContext(), "\u062a\u0645 \u0646\u0633\u062e \u0645\u062d\u062a\u0648\u0649 \u0645\u0631\u0628\u0639 \u0627\u0644\u0646\u0635 \u0627\u0644\u0646\u0627\u062a\u062c", Toast.LENGTH_LONG).show();
            }
        });
        this.share9.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent sharingIntent = new Intent("android.intent.action.SEND");
                sharingIntent.setType("text/plain");
                sharingIntent.putExtra("android.intent.extra.TEXT", Text.this.out9.getText().toString());
                Text.this.startActivity(Intent.createChooser(sharingIntent, "\u0634\u0627\u0631\u0643 \u0628\u0648\u0627\u0633\u0637\u0629 :"));
            }
        });
    }
